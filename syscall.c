...
extern int sys_unshare_with_mount(void);
...
static int (*syscalls[])(void) = {
    ...
    [SYS_close] sys_close,       [SYS_mount] sys_mount,
    ...
    [SYS_kmemtest] sys_kmemtest, [SYS_unshare_with_mount] sys_unshare_with_mount
};
