...
typedef enum POUCH_INTERNAL_STATUS_CODES {
  ...
  FAILED_TO_CREATE_OLD_ROOT_DIR = -29,
  FAILED_TO_PIVOT_ROOT = -30,
  UNLINK_IMAGE_MOUNT_POINT_ERROR_CODE = -31,
  UMOUNT_IMAGE_MOUNT_POINT_ERROR_CODE = -32,
  UNLINK_CGROUP_ERROR_CODE = -33,
  KILL_CONTAINER_ERROR_CODE = -34,
  FAILED_TO_CLOSE_CGROUP_PROCS_FD = -35,
  FAILED_TO_WRITE_TO_CGROUP_PROCS_FD = -36,
  PARSE_CCONF_FAILED_ERROR_CODE = -37,
  FAILED_TO_CREATE_POUCH_CONFIGS_DIR = -38,
  FAILED_TO_BIND_MOUNT_POUCH_CONFIGS_DIR = -39,
