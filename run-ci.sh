...
# cppcheck is really bad at finding standard include headers, on Mac and Linux.
# Fortunately, we can suppress this check, and only scan our custom header files.
