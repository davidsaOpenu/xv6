...
#define CGROUP_CPU_CHILD_LARGE_UPPER_CPU_PERCENTAGE 80
#define CGROUP_CPU_CHILD_LARGE_LOWER_CPU_PERCENTAGE 70
#define CGROUP_CPU_CHILD_SMALL_UPPER_CPU_PERCENTAGE 21
#define CGROUP_CPU_CHILD_SMALL_LOWER_CPU_PERCENTAGE 11
