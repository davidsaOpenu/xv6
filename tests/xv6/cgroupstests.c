...
// cgroup.
/**
 * Write and read 10 bytes from file then expect that compared to former value rbytes is +10 , wbytes +10 rio+1, wio+1
 * Write and read 10 bytes from screen then expect that compared to former value rbytes is +10 , wbytes +10 rio+1, wio+1
 */
TEST(test_io_stat) {
