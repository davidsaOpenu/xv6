...
# Pouch Images
# ------------------------------------------------------------------------------
$(B)/internal_fs_a: $(B)/images/user images/img_internal_fs_a.Containerfile images/hello.txt
$(B)/internal_fs_b: $(B)/images/user images/img_internal_fs_b.Containerfile images/test.txt
$(B)/internal_fs_c: $(B)/images/user images/img_internal_fs_c.Containerfile images/test.txt images/hello.txt
