...
CFLAGS = -DCPU_ENABLED -DEVICE_SUPPORT -DSTORAGE_DEVICE_SIZE=268435456 -DOBJECTS_TABLE_SIZE=200 -fno-pic -static -fno-builtin -fno-strict-aliasing -O2 -Wall -MD -ggdb -m32 -Werror -fno-omit-frame-pointer -std=gnu99
...
run-objfs-tests:
	$(CC) -std=gnu99 -g -fno-builtin -Werror -m32 \
